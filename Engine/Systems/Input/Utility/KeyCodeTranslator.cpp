#include "Engine/Systems/Input/Utility/KeyCodeTranslator.hpp"
...
namespace nova
{
	std::unordered_map<const KeyCode, std::string> KeyCodeTranslator::registry
	{
		...
		{ KeyCode::KEY_NUM_MULTIPLY, "NumMultiply" },
		{ KeyCode::KEY_NUM_DIVIDE, "NumDivide" },
		{ KeyCode::KEY_NUM_ADD, "NumAdd" },
		{ KeyCode::KEY_NUM_SUBTRACT, "NumSubtract" },
		...
		{ KeyCode::KEY_PAGE_UP, "PageUp" },
		{ KeyCode::KEY_PAGE_DOWN, "PageDown" },
		{ KeyCode::KEY_END, "End" },
		...
		{ KeyCode::KEY_PRINT_SCREEN, "PrintScreen" },
		{ KeyCode::KEY_SNAPSHOT, "Snapshot" },
		{ KeyCode::KEY_EXE, "Execute" },
		{ KeyCode::KEY_HELP, "Help" },
		{ KeyCode::KEY_SLEEP, "Sleep" },

		{ KeyCode::KEY_SCROLL_LOCK, "ScrollLock" },
		{ KeyCode::KEY_CAPS_LOCK, "CapsLock" },

		{ KeyCode::KEY_OEM_NUM_EQUAL, "OemNumEqual" },
		...
		{ KeyCode::KEY_RIGHT_SHIFT, "RightShift" },
		{ KeyCode::KEY_RIGHT_ALT, "RightAlt" },
		{ KeyCode::KEY_RIGHT_CTRL, "RightCtrl" },
		{ KeyCode::KEY_RIGHT_WINDOWS, "RightWindows" },
		{ KeyCode::KEY_LEFT_SHIFT, "LeftShift" },
		{ KeyCode::KEY_LEFT_ALT, "LeftAlt" },
		{ KeyCode::KEY_LEFT_CTRL, "LeftCtrl" },
		{ KeyCode::KEY_LEFT_WINDOWS, "LeftWindows" },

		{ KeyCode::KEY_SHIFT, "Shift" },
		{ KeyCode::KEY_ALT, "Alt" },
		{ KeyCode::KEY_CTRL, "Ctrl" },
		{ KeyCode::KEY_WINDOWS, "Windows" },
	};


	std::string KeyCodeTranslator::translate(const KeyCode key_code) noexcept
	{
		return registry[key_code];
	}
}
